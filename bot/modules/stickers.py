...
• `/kangana`*:* reply to a sticker to add it to your pack.
• `/stcrs`*:* Find stickers for given term on combot sticker catalogue
'''
...
KANG_HANDLER = CommandHandler("kangana", kang)
STICKERS_HANDLER = CommandHandler("stcrs", cb_sticker)
